import 'package:chatapp/models/message_data.dart';
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        leading: Align(
          ...
          child: IconBackground(icon: CupertinoIcons.back,
            onTap: () {
